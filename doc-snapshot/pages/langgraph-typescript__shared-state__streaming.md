...
~~~~typescript title="shared-state-streaming.ts"
...
- **[Shared State (overview)](/langgraph-typescript/shared-state)** — the bidirectional
  read + write pattern this extends.
- **[Agent read-only context](/langgraph-typescript/shared-state/agent-readonly)** —
