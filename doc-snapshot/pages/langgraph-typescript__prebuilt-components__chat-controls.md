...
- [CopilotPopup](/langgraph-typescript/prebuilt-components/popup) and [CopilotSidebar](/langgraph-typescript/prebuilt-components/sidebar): the prebuilt surfaces that own modal state.
...
- [Slots](/langgraph-typescript/custom-look-and-feel/slots): the `messageView` / `assistantMessage` slot system used above.
- [Programmatic Control](/langgraph-typescript/programmatic-control): driving agent runs from code without a chat UI.
