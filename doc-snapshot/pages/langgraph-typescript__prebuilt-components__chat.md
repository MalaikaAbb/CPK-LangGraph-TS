...
For a collapsible docked chat, use [CopilotSidebar](/langgraph-typescript/prebuilt-components/sidebar).
For a floating bubble that overlays content, use [CopilotPopup](/langgraph-typescript/prebuilt-components/popup).
For saved conversations and switching between prior conversations, drop in the [Threads Drawer](/langgraph-typescript/prebuilt-components/copilot-threads-drawer) (or go headless with [Headless Threads](/langgraph-typescript/headless-threads)).
...
| `messageView` | Slot for the message list — see [slots](/langgraph-typescript/custom-look-and-feel/slots). |
...
- **CSS variables / class overrides** — see [CSS customization](/langgraph-typescript/custom-look-and-feel/css)
- **Slots (subcomponents)** — see [slots](/langgraph-typescript/custom-look-and-feel/slots)
- **Fully headless** — see [headless UI](/langgraph-typescript/custom-look-and-feel/headless-ui)
