...
use [CopilotSidebar](/langgraph-typescript/prebuilt-components/sidebar). For a fully embedded
chat pane, use [`<CopilotChat>`](/langgraph-typescript/prebuilt-components/chat) directly.
...
| `header` | Slot for the popup header bar — see the [slot system](/langgraph-typescript/custom-look-and-feel/slots). |
...
[custom look and feel](/langgraph-typescript/custom-look-and-feel/slots) for the full slot
reference.
