...
[CopilotPopup](/langgraph-typescript/prebuilt-components/popup). For a fully embedded chat pane,
use [`<CopilotChat>`](/langgraph-typescript/prebuilt-components/chat) directly.
...
| `header` | Slot for the sidebar header bar — see the [slot system](/langgraph-typescript/custom-look-and-feel/slots). |
