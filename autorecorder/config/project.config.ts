...
export const PROJECT: ProjectConfig = {
  ...
  frameworkLabel: "LangGraph (TypeScript)",
  videoPrefix: "LANGGRAPH-TS-react",

  docBaseUrl: "https://docs.copilotkit.ai/langgraph-typescript",
  ...
  backendStartCmd: "cd backend && npm run dev",
